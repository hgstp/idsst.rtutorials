...
Until then, the best way to get a comprehensive overview of the available geoms is to visit the [ggplot2 website](https://ggplot2.tidyverse.org/reference/index.html#layers). To learn more about any single geom, look at its help page, e.g. `?geom_smooth`.
