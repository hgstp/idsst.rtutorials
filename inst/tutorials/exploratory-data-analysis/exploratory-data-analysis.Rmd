...
Continuous variables are a special case of the so-calles **numerical** variables, which can take a wide range of numerical values, and it is sensible to add, subtract, or take averages with those values. A numerical variable, which is not continuous is called discrete.
