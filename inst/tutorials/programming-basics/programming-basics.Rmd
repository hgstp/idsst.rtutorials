...
```{r objects-5-check}
"Great work! However, please keep in mind that using the `rm()` function won't be helpful if you accidentally overwrite one of your own objects."
```
...
In the code chunk below, load the `tidyverse` package. Whenever you load a package R will also load all of the packages that the first package depends on.
